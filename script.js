document.addEventListener('DOMContentLoaded', () => {
    ...
    btnExport.addEventListener('click', () => {
        ...
        // DOIT CORRESPONDRE AUX VARIABLES CSS DANS style.css
        const circleTopPercent = 0.34;  // --circle-top: 34%
        const circleLeftPercent = 0.46; // --circle-left: 46%
        const circleSizePercent = 0.50; // --circle-size: 50%
